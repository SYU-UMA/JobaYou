...
const nextButton = () => {
  ...
  const [isViewInterviewList, setIsViewInterviewList] = React.useState(true);
  ...
  if(!isLogin) {
    ...
    return (
      <div className={styles.Main}>
        ...
        <div>
        {modalIsOpen && <Resume isViewInterviewList={isViewInterviewList} setResumeData={setResumeData} getResumeList={getResumeList} modalIsOpen={modalIsOpen} setModalIsOpen={setModalIsOpen} resumeData={resumeData}/>}
        </div>
